 ...
 */
public class DeathsAttributableToTheEnvironmentDao implements StatisticGetterDao {
    ...
    public DeathsAttributableToTheEnvironmentDao() {
        ...
        this.SQL.append("SELECT y.year, SUM(dbs.measurenment) AS measurenment FROM death_by_environment_statistics dbs \n" +
                "JOIN year y ON dbs.year_id = y.id \n" +
                "JOIN country c ON dbs.country_id = c.id \n" +
    ...
    @Override
    public DeathsAttributableToTheEnvironmentDao addClause(StatisticClauseFields scf, Object value) {
